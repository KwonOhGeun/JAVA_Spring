...
<form class="login-form" name="f" method="post" action="/user/getUserLoginCheck" onsubmit="return doLoginUserCheck(this);">
    <p class="login-text">
    ...
    <input type="text" name="user_id" class="login-username" autofocus="true" required="true" placeholder="Email" />
